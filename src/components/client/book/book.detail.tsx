                ...
                <div style={{ padding: "20px", background: '#fff', borderRadius: 5 }}>
                    <Row gutter={[20, 20]}>
                        ...
                        <Col md={14} sm={24}>
                            ...
                            <Col span={24}>
                                <div className='title'><strong>Tên sách: </strong> {currentBook?.name}</div>
                                <div className='author'>Tác giả: <a href='#'>{currentBook?.author}</a> </div>
                                <div className='title'><strong>Nội dung chính: </strong> {currentBook?.mainText}</div>
                                ...
                                <div className='title'><strong>Mô tả: </strong> {currentBook?.desc}</div>
