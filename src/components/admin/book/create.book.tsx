...
const CreateBook = (props: IProps) => {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            ...
            if (res && res.data?.result) {
                console.log("Category raw response:", res.data.result); //
    ...
    console.log("check category list tuewf create book: " , listCategory)
    const onFinish: FormProps<FieldType>['onFinish'] = async (values) => {
        setIsSubmit(true)

        const { mainText, author, price, quantity, category,desc,name } = values;
